...
"""
Tensorflow code. Treating this as main.py
I guess the txt file has to live on the server
but that's dumb. In this case the voc and pairs
are getting defined every time the app runs. 

If there's another way do it like that
...
def evaluateInput(encoder, decoder, searcher, voc):
    ...
    while(1):
        try:
            ...
            # Add words to voc if not already
            # voc.addSentence(input_sentence)
            # Evaluate sentence
...
#attn_model = 'general'
#attn_model = 'concat'
hidden_size = 500         # Sweet spot is around 300-500 for some reason - If you really care - ( https://papers.nips.cc/paper/7368-on-the-dimensionality-of-word-embedding.pdf )
encoder_n_layers = 2
decoder_n_layers = 2
dropout = 0.1
batch_size = 64
